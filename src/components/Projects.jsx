...
const Projects = () => {
    ...
    const projects = [
        {
            title: 'ShreeShyam-packaging',
            description: 'ShreeShyam Packaging is a responsive eCommerce website developed for selling premium packaging materials, including bags, boxes, jewelry packaging, and customized packaging solutions for businesses and retailers.',
            imageIcon: <Package size={48} className="text-softBlue-500" />,
            tags: ['React', 'Vite', 'Node.js', 'eCommerce Website'],
            category: 'Web',
            githubLink: 'https://github.com/karanudani3011/The-Namratagreen-Foundation',
            liveLink: 'https://shreeshyam-packaging.in/',
        },
